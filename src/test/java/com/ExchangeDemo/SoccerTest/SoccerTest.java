package com.ExchangeDemo.SoccerTest;
...
import com.ExchangeDemo.SoccerPage.SoccerPage;
...
public class SoccerTest extends BaseClass {
	...
	public void MyAccount() throws InterruptedException {
		SoccerPage ingame = new SoccerPage(driver);
		Thread.sleep(3000);
		ingame.IngameNavLink().click();
		test.log(Status.PASS,
				"The \"Soccer\" navigation link has been clicked, leading to the navigation to the In Game page");
		Thread.sleep(5000);
	}
