package com.ExchangeDemo.CricketTest;
...
import com.ExchangeDemo.CricketPage.CricketPage;
...
public class CricketTest extends BaseClass {
	...
	public void MyAccount() throws InterruptedException {
		...
		Thread.sleep(3000);
		cricket.CricketLink().click();
		test.log(Status.PASS,
				"The \"Cricket\" navigation link has been clicked, leading to the navigation to the In Game page");
		Thread.sleep(5000);
	}
